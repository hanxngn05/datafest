    ...
    <section className="bg-black border-2 border-indigo rounded-lg p-8 md:p-10">
      ...
      <div>
        ...
        <p className="text-lg text-white/80 leading-relaxed mb-4">
          The dataset for BOW DataFest 2026 is provided by the American Statistical Association and will remain confidential until the opening ceremony on Friday, April 10 at 5:00 PM.
        </p>
        <p className="text-lg text-white/80 leading-relaxed mb-4">
        ...
        <p className="text-lg text-white/80 leading-relaxed">
          Your mission is to explore the data, identify interesting patterns or insights, formulate research questions, and present your findings in a compelling 5-minute video presentation.
        </p>
      </div>
    </section>
  )
